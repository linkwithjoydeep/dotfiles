...
return {
	...
	config = function()
		...
		vim.api.nvim_set_keymap("n", "<leader>tmp", ":-tabmove<CR>", { noremap = true, desc = "Move tab left" })
		-- move current tab to next position
		vim.api.nvim_set_keymap("n", "<leader>tmn", ":+tabmove<CR>", { noremap = true, desc = "Move tab right" })
